...
export function CardExampleLanding({
  ...
  return (
    <div className='relative -mx-6 h-full sm:mx-0'>
      ...
      <div
        className={cn(
          'relative h-full w-full overflow-hidden rounded-xl bg-zinc-50 p-4 shadow-[0px_0px_0px_1px_theme(colors.zinc.100),0px_2px_2px_0px_theme(colors.zinc.50)] dark:border dark:border-zinc-800 dark:bg-zinc-900 dark:shadow-none',
          className
        )}
      >
        {hasReTrigger && (
