export const metadata = {
  title: 'Animated Button - Kinetic-Kit',
  description:
...
import { AnimatedButtonBasic } from '@/components/examples/animated-button-basic';
...
<ComponentCodePreview
  ...
  filePath='examples/animated-button-basic'
  hasReTrigger
/>

## Code

<CodeBlock filePath='components/core/animated-button.tsx' />
