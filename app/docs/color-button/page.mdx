export const metadata = {
  title: 'Color Button - Kinetic-Kit',
  description:
...
import { ColorButton } from '@/components/core/color-button';
import { ColorButtonBasic } from '@/components/examples/color-button-basic';
...
<ComponentCodePreview
  component={<ColorButtonBasic />}
  filePath='examples/color-button-basic'
  hasReTrigger
/>

## Code

<CodeBlock filePath='components/core/color-button.tsx' />
