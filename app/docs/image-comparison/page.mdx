export const metadata = {
  title: 'Image Comparison - Kinetic-Kit',
  description:
...
import { GridSection } from '@/components/core/image-comparison';
import { ToastBasic } from '@/components/examples/image-comparison-basic';
